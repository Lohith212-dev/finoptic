/* Finn's mark — THE CREATURE.  Hand-drawn artwork, and every number in it is final.
   ...
   The fills WERE literal (#FF5600, never var(--accent)) through v4.2 — the same
   rule brands.js marks follow, artwork carrying its own colour rather than being
   recoloured. Round 17 reverses that outright: on the Blue and Mono presets Finn
   stayed orange while the whole rest of the product changed underneath it, which
   read as the mark ignoring the theme rather than "staying brand orange by
   design." The arms/hub/legs now carry `var(--accent)` — the same token every
   other accent object in the product reads — so the creature repaints with the
   palette switcher instead of standing apart from it. The eyes stay literal
   black; they are not accent-coloured on any preset.
...
const FINN_MARK = '<svg class="finn-mark" viewBox="0 0 112 97" aria-hidden="true"><g class="creature"><g class="limb armL"><path d="M23.0 28.9 L48.2 29.55 L48.2 47.5 L23.2 47.3 Z" transform="translate(-0.10 4)" fill="var(--accent)"/></g><path d="M46.5 29.5 L64.0 29.0 L64.0 46.4 L46.5 47.5 Z" transform="translate(-0.10 4)" fill="var(--accent)"/><g class="limb armR"><path d="M62.5 29.05 L88.8 27.2 L89.2 45.9 L62.5 46.35 Z" transform="translate(-0.10 4)" fill="var(--accent)"/></g><g transform="translate(56 48) rotate(115.023)"><g class="limb legRay"><path d="M1.414 3.028 L-1.414 -3.028 L8.411 -5.624 L40.337 -4.135 C43.319 -3.185 46.255 -2.096 49.191 -1.008 C47.316 4.668 45.394 10.717 43.339 16.243 C39.996 14.993 36.564 13.551 33.312 12.259 Z" fill="var(--accent)"/></g></g><g transform="translate(56 48) rotate(64.977)"><g class="limb legRay"><path d="M-1.764 2.598 L0.858 -3.021 L31.778 -12.756 C35.004 -14.229 38.182 -15.836 41.324 -17.128 C43.788 -12.005 46.313 -6.302 48.692 -0.998 C45.998 0.283 43.164 1.388 40.283 2.36 L8.953 5.172 Z" fill="var(--accent)"/></g></g><g class="eyeOrb"><g class="ges eyeI"><path d="M34.2566 0H48.0473V9.00225C48.0473 11.6468 45.9034 13.7907 43.2588 13.7907H34.2566V0Z" transform="translate(2.96 4)" fill="black"/></g></g><g class="eyeOrb"><g class="ges eyeI"><path d="M58.0366 0H71.8273V13.7907H62.825C60.1805 13.7907 58.0366 11.6468 58.0366 9.00224V0Z" transform="translate(2.96 4)" fill="black"/></g></g></g></svg>';
